...
while len(tickers) != 0 and attempt <= 5:
    ...
    for i in range(len(tickers)):
        try:
            ohlc_mon[tickers[i]] = pdr.get_data_yahoo(tickers[i],datetime.date.today()-datetime.timedelta(3650),datetime.date.today(),interval='m')
...
sharpe(pflio(return_df,6,3),0.01) 
...
DJI = pdr.get_data_yahoo("^DJI",datetime.date.today()-datetime.timedelta(3650),datetime.date.today(),interval='m')
